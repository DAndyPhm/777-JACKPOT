...
struct RuleView: View { //view to show the machine's how to play
    var body: some View {
        ZStack{
            Rectangle() //background ccolor
                ...
                .opacity(0.55)
                .ignoresSafeArea()
            ScrollView{ //scroll view for the user to scroll
            VStack{
                Group{
                Text("777 SLOT MACHINE'S HOW TO PLAY")
                ...
                Text("If you reach a certain point, you will be able to unlock a title!!!")
                }.padding(20)
                }
            }
        }
